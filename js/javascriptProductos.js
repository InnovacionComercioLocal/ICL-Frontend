...
function comprobarSession() {
    ...
    xmlhttp.open("GET", "http://localhost/Proyecto/php/comun/comprobarSession.php", true);
    xmlhttp.send();
}
...
function loadProductos() {
    ...
    xmlhttp.open("GET","http://localhost/Proyecto/php/Productos/modelo/getProductos.php?pagina="+pagina, true);
    xmlhttp.send();
}
