...
function loadProvincias() {
    ...
    xmlhttp.open("GET", "http://localhost/Proyecto/Web_Cliente/php/pedirAdomicilio/getProvincia.php", true);
    xmlhttp.send();
}
...
function loadMunicipios() {
    ...
    xmlhttp.open("GET", "http://localhost/Proyecto/Web_Cliente/php/pedirAdomicilio/getMunicipios.php?idProvincia=" + cogerIdSelectorProv(), true);
    xmlhttp.send();
}
...
function loadCp() {
    ...
    xmlhttp.open("GET", "http://localhost/Proyecto/Web_Cliente/php/pedirAdomicilio/getCP.php?Municipio=" + cogerIdSelectorMun(), true);
    xmlhttp.send();
}
...
function comprobarCampos(){
    ...
    direccion.value===""||numero.value==="") {
        ...
        window.location="./pedirAdomicilio/insertDireccion.php?userDireccion=" + direccionCompuesta;
