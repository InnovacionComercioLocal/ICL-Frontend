    ...
    <div class="container border border-dark w-100 h-100 p-4 my-5">
        ...
        <form action="../modelo/crearProducto.php" id="formularioProducto" method="POST">
                <div class="container my-2 p-0 d-flex color-White-6 rounded-4">
                    ...
                    <div class="container border-start border-dark mx-2">
                        <button class="btn btn-warning mt-5 w-auto" type="button" id="btnValidar">Validar Producto</button>
                        <button class="btn btn-success mb-4 mt-1" type="submit" id="btnEnviar">Crear Producto</button>
                    </div>
                </div>
            </form>
        </div>
