    ...
    if (this.readyState == 4 && this.status == 200) {
        ...
        arrayliProductos.forEach(element => {
            ...
            if (role != "NOSESSION" && role != "USERSESSION") {
                ...
                editar.href = "../../admin/Oferta/vista/editarOferta.php?idProduct=" + arrayCadaProducto[0];
...
function loadProductos() {
    ...
    xmlhttp.open("GET", "http://localhost/php/Ofertas/modelo/getOfertas.php?pagina=" + pagina, true);
    xmlhttp.send();
}
